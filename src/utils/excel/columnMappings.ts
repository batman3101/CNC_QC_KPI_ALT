  ...
  inspectionItem: [
    {
      ...
      dataType: 'string',
      description: {
        ko: '모델 코드 (예: B6 SUB, M1). 등록된 제품 모델과 일치해야 합니다',
        vi: 'Ma mau (VD: B6 SUB, M1). Phai khop voi mau san pham da dang ky',
      },
    },
    {
      field: 'machining_process',
      koHeader: '가공 공정',
      viHeader: 'Cong doan gia cong',
      required: false,
      dataType: 'string',
      description: {
        ko: '가공 공정 단계 (선택사항, 예: CNC0, CNC1, CNC2). 자유 입력',
        vi: 'Cong doan gia cong (tuy chon, VD: CNC0, CNC1, CNC2). Nhap tu do',
      },
    },
    {
      field: 'process_code',
      ...
      dataType: 'string',
      description: {
        ko: '검사 공정 코드 (선택사항, 예: IQC, PQC, OQC). 등록된 검사 공정과 일치해야 합니다',
        vi: 'Ma quy trinh kiem tra (tuy chon, VD: IQC, PQC, OQC). Phai khop voi quy trinh da dang ky',
      },
    },
    {
      field: 'name',
    ...
    },
    {
      ...
      description: {
        ...
        vi: 'numeric (kich thuoc) hoac ok_ng (Dat/Khong dat)',
      },
    },
    {
    ...
    {
      field: 'tolerance_plus',
      koHeader: '허용 공차(+)',
      viHeader: 'Dung sai tren (+)',
      required: false,
      dataType: 'number',
      description: {
        ko: '기준값 기준 위쪽 허용 오차 (수치형 필수, 예: 0.05 → 상한 = 기준값 + 0.05)',
        vi: 'Dung sai tren so voi gia tri chuan (bat buoc neu so, VD: 0.05)',
      },
    },
    {
      field: 'tolerance_minus',
      koHeader: '허용 공차(-)',
      viHeader: 'Dung sai duoi (-)',
      required: false,
      dataType: 'number',
      description: {
        ko: '기준값 기준 아래쪽 허용 오차 (수치형 필수, 양수로 입력, 예: 0.03 → 하한 = 기준값 - 0.03)',
        vi: 'Dung sai duoi so voi gia tri chuan (bat buoc neu so, nhap so duong, VD: 0.03)',
      },
    },
    {
      field: 'unit',
