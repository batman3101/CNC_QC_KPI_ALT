...
export function ReportSummaryCard({ summary, isLoading }: ReportSummaryCardProps) {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
      ...
      {/* Machine Performance */}
      <Card elevation={3}>
        <CardHeader title={t('reports.machinePerformance')} />
        <CardContent>
          <TableContainer component={Paper} elevation={0}>
            <Table size="small">
              <TableHead>
                <TableRow>
                  <TableCell>{t('reports.machine')}</TableCell>
              ...
              <TableBody>
                {summary.inspections_by_machine.map((machine) => (
                  <TableRow key={machine.machine_id} hover>
                    <TableCell>
                    ...
                    <TableCell align="center">
                      <Typography variant="body2">{machine.count}</Typography>
                    </TableCell>
                    <TableCell align="center">
