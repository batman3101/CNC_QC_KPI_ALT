...
// Mock data for machines and models
const mockMachines = [
  { id: 'machine-001', name: 'CNC 밀링 #1' },
  { id: 'machine-002', name: 'CNC 밀링 #2' },
  { id: 'machine-003', name: 'CNC 선반 #1' },
]
        ...
        <TabPanel value={tabValue} index={0}>
          <Grid container spacing={3}>
            <Grid size={{ xs: 12, lg: 6 }}>
              <ReportGenerator machines={mockMachines} models={mockModels} />
            </Grid>
            <Grid size={{ xs: 12, lg: 6 }}>
              <ReportList
