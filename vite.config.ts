...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['A symbol BLUE-02.png', 'ALMUS TECH BLUE.png'],
      manifest: {
        name: 'CNC Quality Inspection KPI',
        short_name: 'CNC QC KPI',
        description: 'CNC 품질 검사 KPI 관리 시스템 / Hệ thống quản lý KPI kiểm tra chất lượng CNC',
        theme_color: '#1976d2',
    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          'vendor-utils': ['date-fns', 'lodash', 'dexie', 'i18next', 'react-i18next'],
        },
      },
    },
